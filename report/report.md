...
*איור 1: עקומות Loss ו-Accuracy לאורך האימון. ניתן לראות התכנסות מהירה ב-epoch 2.*

### Confusion Matrix

![Confusion Matrix](../realorfake-backend/models/confusion_matrix.png)

*איור 2: Confusion Matrix על ה-Validation Set.*

### ROC Curve

![ROC Curve](../realorfake-backend/models/roc_curve.png)

*איור 3: עקומת ROC — AUC גבוה מעיד על הבחנה טובה בין מחלקות.*
...
*הפרויקט פותח בקורס מולטימדיה ולמידת מכונה, 2025–2026.*  
*קוד מקור: [GitHub Repository](https://github.com/IconiqMotion/real-or-fake)*
